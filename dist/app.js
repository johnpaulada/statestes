...
FuseBox.pkg("statestes", {}, function(___scope___){
...
exports.pairedTTest = undefined;

var _inference = require('./inference/inference');

exports.pairedTTest = _inference.pairedTTest;
});
___scope___.file("inference/inference.js", function(exports, require, module, __filename, __dirname){
...
var _basic = require('../basic/basic');
...
___scope___.file("basic/basic.js", function(exports, require, module, __filename, __dirname){
...
function sumOfSquaresOfDifference(numbers) {
  var mean_val = mean(numbers);

  return numbers.reduce(function (acc, number) {
    var difference = number - mean_val;
...
FuseBox.expose([{"alias":"statestes","pkg":"statestes/index.js"}]);
FuseBox.main("statestes/index.js");
FuseBox.defaultPackageName = "statestes";
})
